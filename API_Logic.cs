...
namespace WebAPI
{
    class API_logic
    {
        ...
        public void Upload_Request(RestRequest request)
        {
            ...
            request.AddHeader("Authorization", "Bearer sl.A-jlrxaS9qarO2ScoFqMbJTjcmO_yxRG1Y8PEtf_EhDL6R4wHj_mUYMADA7UHT1gXWt5hLsJBAZCQP6qtUKtkTgLnBSMaYvsVb40SBlIXUMKwsXg0jAFlJsZePFIX9Y0X8m6JxIk9O4x");
        }

        public void GetMetadata_Request(RestRequest request2)
        {
            request2.AddHeader("Authorization", "Bearer sl.A-jlrxaS9qarO2ScoFqMbJTjcmO_yxRG1Y8PEtf_EhDL6R4wHj_mUYMADA7UHT1gXWt5hLsJBAZCQP6qtUKtkTgLnBSMaYvsVb40SBlIXUMKwsXg0jAFlJsZePFIX9Y0X8m6JxIk9O4x"); 
        ...
        {
            request3.AddHeader("Authorization", "Bearer sl.A-jlrxaS9qarO2ScoFqMbJTjcmO_yxRG1Y8PEtf_EhDL6R4wHj_mUYMADA7UHT1gXWt5hLsJBAZCQP6qtUKtkTgLnBSMaYvsVb40SBlIXUMKwsXg0jAFlJsZePFIX9Y0X8m6JxIk9O4x"); 
