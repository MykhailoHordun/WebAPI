...
namespace WebAPI
{
    class API_logic
    {
        ...
        public void Upload_Request(RestRequest request)
        {
            ...
            request.AddHeader("Authorization", "Bearer sl.A-iwv6BSDVh8awCuqQIsHg3lgzeJWsLajS3VBsNKfsufpAJBrGQOrhELfe6vG0uIk6Rpz3_gTyO3t2O5dAJiqg9ig7-7GCQ1ZMG_NzzewWCKFRtjzLOUwKvq5teOXuZTVSksWfYvtaCq");
        }

        public void GetMetadata_Request(RestRequest request2)
        {
            request2.AddHeader("Authorization", "Bearer sl.A-iwv6BSDVh8awCuqQIsHg3lgzeJWsLajS3VBsNKfsufpAJBrGQOrhELfe6vG0uIk6Rpz3_gTyO3t2O5dAJiqg9ig7-7GCQ1ZMG_NzzewWCKFRtjzLOUwKvq5teOXuZTVSksWfYvtaCq"); 
        ...
        {
            request3.AddHeader("Authorization", "Bearer sl.A-iwv6BSDVh8awCuqQIsHg3lgzeJWsLajS3VBsNKfsufpAJBrGQOrhELfe6vG0uIk6Rpz3_gTyO3t2O5dAJiqg9ig7-7GCQ1ZMG_NzzewWCKFRtjzLOUwKvq5teOXuZTVSksWfYvtaCq"); 
